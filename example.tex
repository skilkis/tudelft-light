...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Introduction/Figures/flame.jpg}
...
\begin{subfigure}[b]{0.5\textwidth}
  \centering
  \includegraphics[width=.85\textwidth]{Introduction/Figures/flame.jpg}
...
Starting with variables, you need to use a nomenclature code when you introduce a variable for the FIRST time, such that the variable is listed on the list of symbols. An example is given below by \cref{eq:exampleeq}.
...
In order to maintain a coherent unit definition the \texttt{siunitx} package is used. Everytime a unit is necessary, such as when specifying \num{5} \si{\kilogram}, which is generated with the code below:
